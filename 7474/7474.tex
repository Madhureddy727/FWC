...
\begin{figure}[h!]                           
\centering                                 
\includegraphics[width=0.2\textwidth]{ /storage/emulated/0/Documents/seven.png}                                           
\caption{\label{fig-2:Gates}}               
\end{figure}
\begin{figure}[h!]                           
\centering                            
\includegraphics[width=0.5\textwidth]{ /storage/emulated/0/Documents/7474ic.png }                      
\caption{\label{fig-1:Gates}}           
\end{figure}

\begin{figure}[h!]                           
\centering                                 
\includegraphics[width=0.4\textwidth]{  /storage/emulated/0/Documents/7447pin.png  }                                           
...
\item Make the connections of arduino, 7447 and two 7474 ICs according to Fig-4.
	\begin{figure}[h!] 
	\centering 
	\includegraphics[width=0.5\textwidth]{ /storage/emulated/0/Documents/7474c.png     }
...
\begin{figure}[h!]                           
\centering                                 
\includegraphics[width=0.3\textwidth]{  /storage/emulated/0/Pictures/Screenshots/Screenshot_20241023-100354.png}                                           
...
\section{RESULTS}
 ...
 \end{enumerate}
		 \begin{figure}[h!] 
	\centering 
	\includegraphics[width=0.4\textwidth]{ /storage/emulated/0/Documents/7474out.png    }
